...
class IngredientRepository(BaseRepository[Any, Any, Any]):
    ...
    def __init__(self, supabase: Client):
        from gastropartner.core.models import Ingredient, IngredientCreate, IngredientUpdate
        super().__init__(
            supabase=supabase,
...
class RecipeRepository(BaseRepository[Any, Any, Any]):
    ...
    def __init__(self, supabase: Client):
        from gastropartner.core.models import Recipe, RecipeCreate, RecipeUpdate
        super().__init__(
            supabase=supabase,
            table_name="recipes",
            model_class=Recipe,
...
class MenuItemRepository(BaseRepository[Any, Any, Any]):
    ...
    def __init__(self, supabase: Client):
        from gastropartner.core.models import MenuItem, MenuItemCreate, MenuItemUpdate
        super().__init__(
            supabase=supabase,
